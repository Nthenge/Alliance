    ...
    if(mysqli_num_rows($result) > 0)
    {
        ...
        while($row = mysqli_fetch_assoc($result))
        {
            $data = '<table class="table table-bordered table-striped">
                     ...
                     <td width="70%"><label>Abraham Mutinda</label></td> 
                     </tr>  
                    <tr>  
                     <td width="30%"><label>Position</label></td>  
                     <td width="70%"><label>Landlord</label></td>  
                    </tr> 
                    
     
                   <tr>  
                     <td width="30%"><label>Email Address</label></td>  
                     <td width="70%"><label>abrahamnetsec@gmail.com</label></td>
                    </tr>
                   <tr>  
                     <td width="30%"><label>Phone Number</label></td>  
                     <td width="70%"><label>0713331448</label></td>  
                   </tr>
...
<html>
<head>
	<title>Blessed Property Dashboard </title>
	<meta charset="utf-8">
