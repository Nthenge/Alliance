...
<html lang="en">
<head>
  <title>Register Property | Sign Up</title>
  <meta charset="UTF-8">
...
<body style="background-color: #999999;">
  ...
  <div class="limiter">
    <div class="container-login100">
      <div class="login100-more" style="background-image: url(../images/allianceLoginPic.jpg);"></div>
      ...
      <div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
        <form class="login100-form validate-form" name= "myform" method="post" action="../php/register.php">
          <span class="login100-form-title p-b-59">
            ...
            <input class="input100" type="text" name="name" placeholder="Abraham Mutinda">
            <span class="focus-input100"></span>
          </div>
                    
                    <div class="wrap-input100 validate-input" data-validate="E-mail Address is required">
            <span class="label-input100">Email Address</span>
            <input class="input100" type="text" name="email" placeholder="abrahamnetsec@gmail.com">
            <span class="focus-input100"></span>
          </div>
                    
                    <div class="wrap-input100 validate-input" data-validate="Phone Number is required">
            <span class="label-input100">Phone Number</span>
            <input class="input100" type="text" name="phoneNo" placeholder="0713331447"> 
            <span class="focus-input100"></span>
          </div>
